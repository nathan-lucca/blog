...
$query = "SELECT posts.*, GROUP_CONCAT(categorias.nome_categoria) AS categorias
          FROM posts
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <div class="search-container" style="position: relative; width: auto; text-align: right;">
                            <form id="searchForm" action="./views/search.php" method="get">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="category mb-2">
                                            ...
                                            foreach ($post_categorias as $post_categoria) {
                                                ...
                                                $categorias_html[] = '<a href="./views/category.php?id=' . $categoria_id . '" class="categoria-post">' . $post_categoria . '</a>';
                                            }
                                        ...
                                        <h5 class="card-title titulo-post">
                                            <a href="./views/post.php?id=<?php echo $post_id; ?>" class="titulos">
                                                <?php
                                        ...
                                        <span class="leia-mais">
                                            <a href="./views/post.php?id=<?php echo $post_id; ?>">Leia Mais <i class="bi bi-arrow-right-circle-fill"></i></a>
                                        </span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-3 mb-3">
                ...
                <div class="card rounded-0 shadow mb-3">
                    ...
                    <div class="card-body">
                        <div class="card-body d-flex align-items-center justify-content-center flex-column">
                            ...
                            <a href="./views/about.php" class="btn btn-primary text-center btn-animation">Saiba Mais <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card rounded-0 shadow mb-3" style="height: 150px;">
                    ...
                    <div class="d-flex align-items-center justify-content-center" style="height: 100%;">
                        <form action="./views/category.php" id="categorySelectForm">
            ...
            <div class="col-md-8">
                <div class="pagination-block" style="display: block; width: 100%;">
                    <ul class="list" style="margin: 0; padding: 0; list-style: none;">
                        ...
                        $total_posts_result = mysqli_query($mysqli, $total_posts_query);
                        $total_posts_row = mysqli_fetch_assoc($total_posts_result);
                        $total_posts = $total_posts_row['total'];

                        $total_paginas = ceil($total_posts / $resultados_por_pagina);

                        if ($pagina_atual > 1) {
                            echo '<li class="item"><a class="page-numbers" href="index.php?page=' . ($pagina_atual - 1) . '"><i class="bi bi-caret-left-fill"></i></a></li>';
                        }
                        ...
                        if ($pagina_atual < $total_paginas) {
                            echo '<li class="item"><a class="page-numbers" href="index.php?page=' . ($pagina_atual + 1) . '"><i class="bi bi-caret-right-fill"></i></a></li>';
                        }
                        ?>
                    </ul>
                </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-md-3 mb-3 footer-alinhamento">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="./views/about.php" class="site">Sobre</a></li>
                        <li><a href="./views/contact.php" class="site">Contato</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 footer-alinhamento">
                    ...
                    <ul class="list-unstyled d-flex align-items-center justify-content-center" style="gap: 20px;">
                        <li class="item-rede-social instagram"><a href="https://www.instagram.com/ciber.brasil/" target="_blank"><i class="bi bi-instagram instagram"></i></a>
                        </li>
                    </ul>
                </div>
        ...
        function redirectCategory() {
            ...
            if (selectedCategoryId !== "0") {
                document.getElementById("categorySelectForm").action =
                    "views/category.php?id=" + selectedCategoryId;
